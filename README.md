Simulates and trains a reinforcement learning agent to track a moving target under different observation strategies with the aim of catching the target.
